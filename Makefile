...
bin/main: obj/main.o obj/Engine.o obj/Button.o obj/FontManager.o
	clang++ $(CPPFLAGS) -o bin/main obj/main.o obj/Engine.o obj/Button.o obj/FontManager.o
...
obj/FontManager.o: src/FontManager.cpp src/FontManager.h
	clang++ $(CPPFLAGS) -o obj/FontManager.o -c src/FontManager.cpp
